...
def add_methods(document, values, table_specs) -> None:
    ...
    add_paragraph(
        ...
        "seasons; the C-MAPSS engine was the independent simulation unit.",
    )
    add_paragraph(
        document,
    ...
    add_paragraph(
        ...
        "evapotranspiration from NASA POWER weather after converting shortwave radiation "
        "from kWh m−2 day−1 to MJ m−2 day−1, and compares a training-period "
