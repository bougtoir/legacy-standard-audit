...
SOURCES = [
    {
        "source_id": "AN-REPRO-ARCHIVE-V1",
        "case_id": "",
        "source_type": "reproducibility_archive",
        "title": "Legacy Standard Audit analysis input snapshots v1",
        "publisher_or_custodian": "bougtoir/legacy-standard-audit",
        "url": (
        ...
        "identifier": "GitHub release analysis-inputs-v1",
        "version_or_date": "2026-09-24",
        "retrieval_conditions": "Public immutable GitHub release asset",
        "filename": "legacy_standard_audit_analysis_inputs_v1.zip",
        "license_or_terms": (
            "Bundle contains only redistributable UCI, NASA, OPSD, and NYC inputs; "
            "source-specific terms remain applicable"
        ),
        "notes": (
            "Stable archive for exact fresh-clone reconstruction of the five "
            "numerical input snapshots"
        ),
    },
    {
